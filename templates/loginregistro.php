...
<div class="col">
    ...
    <form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post">
        ...
        <input id="name_register" type="text" name="firstname" placeholder="<?php _e("Nombre", "enfermeria"); ?>" required/></p>
        <p><label for="lastname_register"><?php _e("Apellidos", "enfermeria"); ?></label>
        <input id="lastname_register" type="text" name="lastname" placeholder="<?php _e("Apellidos", "enfermeria"); ?>" required/></p>
        <p><label for="email_register"><?php _e("Email", "enfermeria"); ?></label>
        <input id="email_register" type="email" name="email" placeholder="<?php _e("nombr@dominio.com", "enfermeria"); ?>" required/></p>
        <p><label for="password_register"><?php _e("Contraseña", "enfermeria"); ?></label>
        <input id="password_register" type="password" name="password" placeholder="<?php _e("Contraseña", "enfermeria"); ?>" required /></p>
